...
function Roles() {
  ...
  async function updateStatus(values) {
    ...
    try {
      const postData = await axios.post(
        "https://panelserver.digitalkrantiindia.com/api/role/status",
        val,
        config
      );
  ...
  const getRoleList = async () => {
    ...
    setRoleList(postData.data.response.docs);
  ...
  async function UpdateCreateRole(values) {
    try {
      if (moduleUpdate) {
        const postvalue = { ...values, roleID: itemID, updatedby: Auth.id };
        const response = await axios.post(
          "https://panelserver.digitalkrantiindia.com/api/role/update",
          postvalue,
          config
        );
        ...
        const response = await axios.post(
          "https://panelserver.digitalkrantiindia.com/api/role/create",
          val,
          config
        );
        return response.data;
  ...
  useEffect(() => {
    formik.setValues({
      rolename: moduleUpdate ? updateData.rolename : "",
    });
      ...
      <div className="f1">
        <div className="card overflow-auto">
          <div className="card-header d-flex justify-content-between align-items-center ">
            <h4 className="card-title m-2">All Role </h4>
            ...
            >
              <form onSubmit={formik.handleSubmit}>
                <DialogTitle>{"Role Create"}</DialogTitle>
                <DialogContent>
      ...
      >
        <form onSubmit={formik.handleSubmit}>
          ...
          <DialogContent>
            <div style={{ paddingTop: "10px" }}>
              <FormControl sx={{ width: "400px" }}>
                <InputLabel htmlFor="component-outlined">RoleName</InputLabel>
                <OutlinedInput
                  id="component-outlined"
                  label="RoleName"
                  name="rolename"
