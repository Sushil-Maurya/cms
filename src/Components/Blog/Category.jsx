  ...
  async function updateStatus(values) {
    ...
    try {
      const postData = await axios.post(
        "https://panelserver.digitalkrantiindia.com/api/category/status",
        val,
        config
      );
    ...
    try {
      if (moduleUpdate) {
        ...
        const response = await axios.post(
          "https://panelserver.digitalkrantiindia.com/api/category/update",
          postvalue,
          config
        );
        ...
        let val = values;
        val = { ...val, createdby: Auth.id, categoryImage: imageUrl };
        console.log(val);
        const response = await axios.post(
          "https://panelserver.digitalkrantiindia.com/api/category/create",
          val,
          config
        );
        return response.data;
